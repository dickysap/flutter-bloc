...
import '../../../tv/lib/presentation/pages/tv_detail_page.dart';
...
void main() {
  ...
  testWidgets(
    ...
    when(mockTvDetailNotifier.tvRecommendationState)
        .thenReturn(RequestState.Loaded);
    when(mockTvDetailNotifier.tvRecommendation).thenReturn(<Tv>[]);
    when(mockTvDetailNotifier.isTvAddedToWatchlist).thenReturn(false);
  ...
  testWidgets(
    ...
    when(mockTvDetailNotifier.tvRecommendationState)
        .thenReturn(RequestState.Loaded);
    when(mockTvDetailNotifier.tvRecommendation).thenReturn(<Tv>[]);
    when(mockTvDetailNotifier.isTvAddedToWatchlist).thenReturn(true);
  ...
  testWidgets(
    ...
    when(mockTvDetailNotifier.tvRecommendation).thenReturn(<Tv>[]);
    when(mockTvDetailNotifier.isTvAddedToWatchlist).thenReturn(false);
    when(mockTvDetailNotifier.watchlistMessageTv)
  ...
  testWidgets(
    ...
    when(mockTvDetailNotifier.tvRecommendation).thenReturn(<Tv>[]);
    when(mockTvDetailNotifier.isTvAddedToWatchlist).thenReturn(false);
    when(mockTvDetailNotifier.watchlistMessageTv).thenReturn('Failed');
